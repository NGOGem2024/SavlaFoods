...
// // //           } else {
// // //             setOrders(prevOrders => [...prevOrders, ...result.data.orders]);
// // //           }
...
// // //               style={[
// // //                 styles.statusText,
// // //                 {color: item.status === 'PENDING' ? '#d97706' : '#6B7280'},
// // //               ]}>
// // //               {item.status}
// // //             </Text>
// // //           </View>
...
// // //           <MaterialIcons name="chevron-right" size={16} color="#d97706" />
// // //         </TouchableOpacity>
// // //       </View>
// // //     </TouchableOpacity>
// // //   );
...
// // //           onPress={() => fetchPendingOrders(1, true)}>
...
// // //       remarks: `Remarks for pending order ${i}`,
// // //       totalItems,
...
// //     },
// //     [customerID],
// //   ); // Add customerID to dependency array
...
// //     // Navigate to the OrderDetailsScreen with the full order object
...
// //       <FlatList
// //         data={orders}
// //         keyExtractor={item => `order-${item.orderId}-${item.orderNo}`}
// //         renderItem={renderOrderCard}
// //         contentContainerStyle={styles.list}
// //         refreshControl={
// //           <RefreshControl refreshing={refreshing} onRefresh={onRefresh} />
...
//   const customerID = routeCustomerID || contextCustomerID;

//   // Check if we're coming with a specific order to highlight
//   const specificOrderId = route.params?.orderId;

//   // If we have a specific order from OrderConfirmationScreen, add it to our orders
//   useEffect(() => {
//     if (specificOrderId && specificOrderId !== 0 && route.params) {
//       const {
//         orderNo,
//         transporterName,
//         deliveryDate,
...
//       // Only add the specific order if we have complete data and it's a valid order
//       if (orderNo && items && items.length > 0) {
//         const specificOrder: PendingOrder = {
...
//           customerName: '', // We don't have this info
//           totalItems: items.length,
//           totalQuantity: items.reduce(
//             (sum, item: any) => sum + (item.ORDERED_QUANTITY || 0),
//             0,
//           ),
//           items: items.map((item: any) => ({
//             detailId: item.ITEM_ID || 0,
//             itemId: item.ITEM_ID || 0,
//             itemName: item.ITEM_NAME || '',
//             lotNo: item.LOT_NO || '',
//             itemMarks: item.ITEM_MARKS || '',
//             vakalNo: item.VAKAL_NO || '',
//             requestedQty: item.ORDERED_QUANTITY || 0,
//             availableQty: item.AVAILABLE_QTY || 0,
//             status: 'NEW',
//           })),
//         };

//         // Set this specific order first for immediate display
//         setOrders([specificOrder]);
//       }
//     }
//   }, [route.params, specificOrderId]);
...
//           // If we have a specific order and this is first page load or refresh,
...
//             (refresh || pageNum === 1)
//           ) {
//             // Filter out the specific order if it exists in the API response
//             const filteredOrders = normalizedOrders.filter(
//               order => order.orderId !== specificOrderId,
//             );

//             // Check if we already have our specific order in state
//             const hasSpecificOrder = orders.some(
//               order => order.orderId === specificOrderId,
//             );

//             if (hasSpecificOrder) {
//               // Keep our specific order at the top and add other orders
//               setOrders(prevOrders => {
//                 const specificOrder = prevOrders.find(
//                   o => o.orderId === specificOrderId,
//                 );
//                 return specificOrder
//                   ? [specificOrder, ...filteredOrders]
//                   : [...filteredOrders];
//               });
//             } else {
...
//             }
//           } else {
//             // Normal case - no specific order or paginating
//             if (refresh || pageNum === 1) {
...
//       }
//     },
//     [customerID, orders, specificOrderId],
//   );

//   useEffect(() => {
//     // If we don't have a specific order or it's an empty placeholder (orderId = 0),
//     // fetch all pending orders
//     if (!specificOrderId || specificOrderId === 0) {
//       fetchPendingOrder();
//     } else {
//       // If we have a specific order, still fetch all orders but with a slight delay
//       // to allow the UI to display the specific order first
...
//     }
//   }, [fetchPendingOrder, specificOrderId]);
