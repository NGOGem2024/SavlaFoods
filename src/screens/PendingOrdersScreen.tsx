...
//   // Add this useEffect to refresh when coming back from edit

//   // Add this useEffect to refresh data when screen comes into focus
//   useEffect(() => {
//     const unsubscribe = navigation.addListener('focus', () => {
//       fetchPendingOrder(1, true); // Force refresh when returning to this screen
//     });
//     return unsubscribe;
//   }, [navigation]);
...
//       order,
//       timestamp: new Date().getTime(), // Add this line
//     });
//   };
...
//         let dayNum = parseInt(day, 10); // Add one day
