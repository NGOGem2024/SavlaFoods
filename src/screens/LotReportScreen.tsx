...
//                         width: `${Math.floor(
//                           (summary.inwardCount /
//                             (summary.inwardCount + summary.outwardCount)) *
//                             100,
//                         )}%`,
//                       },
//                     ]}
...
//                 {/* Available Quantity */}
//                 {/* {lotDetails?.AVAILABLE_QTY !== undefined && (
//                   <View style={styles.balanceRow}>
//                     <Text style={styles.balanceLabel}>Available Quantity:</Text>
//                     <Text style={[styles.balanceValue, {color: '#009688'}]}>
...
//                           keyExtractor={(item, index) => `inward-${index}`}
...
//                           keyExtractor={(item, index) => `outward-${index}`}
//                           renderItem={({item, index}) => (
//                             <View
//                               style={[
//                                 styles.tableRow,
